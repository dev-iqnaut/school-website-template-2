  ...
  if (size === "6xl") {
    return (
      <SlideUp delay={2}>
        <h1
          className={cn(
            `xl:text-[60px] lg:text-4xl md:text-5xl text-4xl font-bold xl:leading-[128%] lg:leading-[125%] md:leading-[120%]`,
            className
          )}
        >
          {children}
  ...
  if (size === "3.5xl") {
    return (
      <SlideUp delay={2}>
        <h2
          className={cn(
            `font-semibold lg:max-w-[900px] lg:text-[30px] md:text-[28px] text-xl lg:leading-[130%] md:leading-[120%] leading-[110%]`,
            className
          )}
        >
          {children}
