    ...
    <section className="bg-warm pt-[78px] lg:mb-15 mb-10 relative">
      <div className="container relative">
        <div className="flex flex-col items-center text-center relative z-10">
          <Title size={"6xl"} className={"font-normal max-w-[776px]"}>
            <span className="relative">Welcome to IQnaut High School:   <span className="absolute -left-6 top-1 text-3xl text-[#0A6375]"><ThreeLine /></span></span>
            <span className="font-bold">Shaping Futures,</span> <span className="font-bold text-destructive-foreground">Nurturing Potential</span>
          </Title>
          ...
          <p className="pt-5 max-w-[431px]">We see potential where others see limitations. Every child is a unique universe of possibilities waiting to be explored</p>
          <div className="mt-6">
